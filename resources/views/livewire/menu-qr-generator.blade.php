        ...
        @if($restaurant)
            ...
            <div class="d-grid gap-2 mb-4">
                ...
                <a
                    href="{{ $menuUrl }}"
                    target="_blank"
                    wire:loading.class="disabled opacity-50 pe-none"
                    ...
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-8">
                            <div class="d-flex align-items-start gap-3">
                                @if($restaurant->logo_path)
                                    <img src="{{ asset('storage/' . $restaurant->logo_path) }}" alt="logo" class="rounded border p-1 bg-white shadow-sm" height="60" width="60" style="object-fit: contain;">
                                @endif
                                <div>
                                    <h6 class="fw-bold mb-1 text-dark text-uppercase letter-spacing-1">{{ $restaurant->name }}</h6>
                                    @if($restaurant->description)
                                        <p class="text-muted mb-2" style="font-size: 0.75rem; line-height: 1.3;">{{ \Illuminate\Support\Str::limit($restaurant->description, 100) }}</p>
                                    @endif
                        ...
                        <div class="col-4 text-end">
                            <div class="d-inline-block text-center mt-auto">
                                <img src="{{ $restaurant->restaurant_wifi_qr }}" alt="Wifi QR" class="rounded border p-1 bg-white shadow-sm" height="100" width="100" style="object-fit: contain;">
                                <div class="mt-1">
                                    <span class="badge bg-label-info p-1 px-2 rounded-pill text-uppercase fw-bold" style="font-size: 0.6rem;">Connect to WIFI</span>
                                </div>
                            </div>
                        </div>
                    </div>
