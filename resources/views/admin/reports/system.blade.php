...
<div class="mb-4 d-flex align-items-center justify-content-between">
    <div class="d-flex align-items-center text-truncate">
        ...
        <div class="text-truncate">
            <h4 class="fw-bold mb-0 text-truncate">Global System Performance</h4>
            <p class="text-muted mb-0 small text-uppercase ls-1">Aggregated Analytics Dashboard</p>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="card report-card border-0 shadow-sm h-100">
            <div class="card-body">
                ...
                <h6 class="text-muted fw-normal mb-1 small">Global Orders</h6>
                <h4 class="fw-bold text-dark mb-0">{{ number_format($totals->total_orders ?? 0) }}</h4>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card report-card border-0 shadow-sm h-100">
            <div class="card-body">
                ...
                <h6 class="text-muted fw-normal mb-1 small">System Revenue</h6>
                <h4 class="fw-bold text-dark mb-0">Rs. {{ number_format($totals->total_revenue ?? 0, 2) }}</h4>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card report-card border-0 shadow-sm h-100">
            <div class="card-body">
                ...
                <h4 class="fw-bold text-dark mb-0">{{ number_format($totals->total_views ?? 0) }}</h4>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card report-card border-0 shadow-sm h-100">
            <div class="card-body">
                ...
                <h6 class="text-muted fw-normal mb-1 small">Total Restaurants</h6>
                <h4 class="fw-bold text-dark mb-0 text-truncate">{{ number_format($totalRestaurants) }}</h4>
            </div>
        </div>
    </div>
</div>
...
<div class="row g-4">
    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-header bg-white border-bottom py-3">
                <h6 class="mb-0 fw-bold">Global Revenue & Order Trends (Last 30 Days)</h6>
            </div>
            <div class="card-body">
    ...
    <div class="col-lg-4">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-header bg-white border-bottom py-3">
                <h6 class="mb-0 fw-bold">Overall Audience Engagement</h6>
            </div>
            <div class="card-body">
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        var revenueOptions = {
            ...
            yaxis: [{
                ...
                labels: { style: { colors: '#696cff' }, formatter: val => val.toLocaleString() }
            }, {
                opposite: true,
                title: { text: 'Total Orders', style: { color: '#03c3ec' } },
                labels: { style: { colors: '#03c3ec' }, formatter: val => Math.round(val) }
            }],
        ...
        // Views Chart
        var viewsOptions = {
            series: [{ name: 'Global Views', data: views }],
